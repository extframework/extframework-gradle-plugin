...
import dev.extframework.dev.api.LaunchContext
...
public fun main(args: Array<String>) {
    val contextPath = args.getOrNull(0) ?: throw Exception("Invalid arguments. First arg must be a path.")

    val launchContext = basicObjectMapper.readValue<LaunchContext>(File(contextPath))

    launch(BootLoggerFactory()) {
        runBlocking {
            val archiveGraph = setupArchiveGraph(getHomedir())
